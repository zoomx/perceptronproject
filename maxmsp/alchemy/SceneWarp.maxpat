{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 6.0, 61.0, 800.0, 487.0 ],
		"bglocked" : 0,
		"defrect" : [ 6.0, 61.0, 800.0, 487.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 449.0, 95.0, 21.5, 18.0 ],
					"id" : "obj-49",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 472.0, 94.0, 20.5, 18.0 ],
					"id" : "obj-50",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 415.0, 95.0, 32.5, 18.0 ],
					"id" : "obj-51",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 387.0, 96.0, 24.5, 18.0 ],
					"id" : "obj-54",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 334.0, 94.0, 21.5, 18.0 ],
					"id" : "obj-48",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 358.0, 94.0, 20.5, 18.0 ],
					"id" : "obj-47",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 299.0, 95.0, 32.5, 18.0 ],
					"id" : "obj-46",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 271.0, 96.0, 24.5, 18.0 ],
					"id" : "obj-45",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 402.0, 16.0, 50.0, 20.0 ],
					"id" : "obj-44",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 171.0, 18.0, 50.0, 20.0 ],
					"id" : "obj-41",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 611.0, 140.0, 31.0, 15.0 ],
					"id" : "obj-53",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 657.0, 147.0, 44.0, 15.0 ],
					"id" : "obj-52",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 395.0, 129.0, 86.5, 20.0 ],
					"id" : "obj-43",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 293.0, 129.0, 86.5, 20.0 ],
					"id" : "obj-42",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 241.0, 17.0, 130.0, 20.0 ],
					"id" : "obj-40",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 425.828644, 768.0, 23.171356 ],
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 699.0, 267.0, 581.0, 406.0 ],
						"bglocked" : 0,
						"defrect" : [ 699.0, 267.0, 581.0, 406.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"fontsize" : 9.0,
									"outlettype" : [ "jit_gl_texture", "" ],
									"patching_rect" : [ 72.0, 50.0, 259.0, 17.0 ],
									"id" : "obj-4",
									"fontname" : "Arial"
								}
...
, 							{
								"box" : 								{
									...
									"fontsize" : 9.0,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 72.0, 71.0, 370.0, 17.0 ],
									"id" : "obj-5",
									"fontname" : "Arial"
								}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1.181538, 177.260864, 71.0, 32.0 ],
					"id" : "obj-25",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 35.813374,
					"outlettype" : [ "" ],
					"patching_rect" : [ 518.418457, 134.087021, 89.446152, 46.0 ],
					"id" : "obj-26",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.840322,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 1.181538, 389.278778, 167.0, 20.0 ],
					"id" : "obj-30",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.840322,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 1.181538, 151.089508, 208.0, 20.0 ],
					"id" : "obj-33",
					"fontname" : "Arial"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 527.918457, 204.810745, 490.386139, 204.810745 ]
				}
