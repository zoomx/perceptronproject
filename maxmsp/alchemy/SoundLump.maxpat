{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 0.0, 45.0, 800.0, 487.0 ],
		"bgcolor" : [ 0.784314, 0.784314, 0.705882, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 0.0, 45.0, 800.0, 487.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 656.0, 58.0, 52.0, 18.0 ],
					"id" : "obj-43",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 647.0, 36.0, 39.0, 18.0 ],
					"id" : "obj-39",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 463.181549, 362.253204, 17.723078, 17.723078 ],
					"id" : "obj-4"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.668376,
					"outlettype" : [ "" ],
					"patching_rect" : [ 463.181549, 385.424561, 80.344612, 18.0 ],
					"id" : "obj-33",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.840322,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 482.086151, 361.094635, 41.353848, 20.0 ],
					"id" : "obj-34",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 482.086151, 336.764709, 47.261539, 20.0 ],
					"id" : "obj-35",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.window perceptron @depthbuffer 1 @size 640 480 @fsaa 1",
					"numinlets" : 1,
					"numoutlets" : 2,
					"fontsize" : 10.137484,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 543.074829, 408.082458, 290.0, 18.0 ],
					"id" : "obj-1",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 408.181549, 487.253204, 17.723078, 17.723078 ],
					"id" : "obj-37"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.668376,
					"outlettype" : [ "" ],
					"patching_rect" : [ 408.181549, 510.424561, 80.344612, 18.0 ],
					"id" : "obj-38",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.840322,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 427.086151, 486.094635, 41.353848, 20.0 ],
					"id" : "obj-40",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.840322,
					"outlettype" : [ "int", "int", "int", "int" ],
					"patching_rect" : [ 427.086151, 461.764709, 47.261539, 20.0 ],
					"id" : "obj-41",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 11.09653,
					"patching_rect" : [ 489.707703, 486.094635, 218.0, 45.0 ],
					"id" : "obj-42",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 27.509304,
					"outlettype" : [ "" ],
					"patching_rect" : [ 563.914124, 24.444157, 70.0, 36.0 ],
					"id" : "obj-15",
					"fontname" : "Arial"
				}
